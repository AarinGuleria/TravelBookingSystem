        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          <motion.div variants={itemVariants} className="contact-info space-y-4 sm:space-y-6">
            ...
            >
              ...
              <span className="text-base sm:text-lg">info@yatra.com</span>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05, rotate: -2 }}
            ...
            >
              ...
              <span className="text-base sm:text-lg">+1 (800) 123-4567</span>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05, rotate: 2 }}
            ...
            >
              <img
                src="src/assets/images/elements/BecomeAnAuthorImg.png"
                alt="Adventure"
