...
const carsData: Car[] = [
  {
    ...
    fuelType: "Gasoline",
    pricePerDay: 4000,
    amenities: ["wifi", "ac", "bluetooth"],
    details: {
      year: 2022,
      mileage: "24,000 km",
      color: "Silver",
      additionalFeatures: ["Backup Camera", "Cruise Control"]
    }
  },
  {
    brand: "Honda",
    model: "CR-V",
    logo: "src/assets/cars/honda.jpeg",
    type: "SUV",
    seats: 5,
    transmission: "Automatic",
    fuelType: "Hybrid",
    ...
    details: {
      ...
      mileage: "13,000 km",
      color: "Blue",
      additionalFeatures: ["Lane Departure Warning", "Apple CarPlay"]
    }
  },
  {
    brand: "Ford",
    ...
    fuelType: "Gasoline",
    pricePerDay: 6400,
    amenities: ["bluetooth", "ac", "gps"],
    details: {
      year: 2022,
      mileage: "8,000 km",
      color: "Red",
      additionalFeatures: ["Leather Seats", "Premium Sound System"]
    }
  },
  {
    brand: "Tesla",
    model: "Model 3",
    logo: "src/assets/cars/tesla.png",
    type: "Electric Sedan",
    seats: 5,
    transmission: "Automatic",
    fuelType: "Electric",
    ...
    details: {
      ...
      mileage: "5,000 km",
      color: "White",
      additionalFeatures: ["Autopilot", "Full Self-Driving Capability"]
    }
  },
  {
    brand: "Volkswagen",
    model: "Golf",
    logo: "src/assets/cars/volkswagen.png",
    type: "Hatchback",
    seats: 5,
    transmission: "Automatic",
    fuelType: "Gasoline",
    ...
    details: {
      ...
      mileage: "19,000 km",
      color: "Black",
      additionalFeatures: ["Touchscreen Infotainment", "Adaptive Cruise Control"]
    }
  }
];
